...
### Зависимости
етров в Kotlin (вызываемый только с помощью рефлексии) для поддержки Spring JPA,  
...
- `org.jetbrains.kotlin.plugin.jpa` - создает класс без парамgs.addAll("-Xjsr305=strict")` - для поддержки Kotlin null-safety в Spring.
